...
# ===================================
# Description: This module is used to gather Facts about a Container/Pluggable or Non Multitenant database. It uses a python library located here: ansible_oracle_aix/library/oracle_facts
...
# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/db-facts-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
# Name of the Playbook: ansible_oracle_aix/db-facts-task.yml
