...
# =================================
# Description: This module is used to gather global statistics of the database. It uses a python library located here: ansible_oracle_aix/library/oracle_awr
...
# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/globalstats-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
# Name of the Playbook: ansible_oracle_aix/globalstats-task.yml
...
[ansible@x134vm232 ansible_oracle_aix]$ ansible-playbook globalstats-task.yml
