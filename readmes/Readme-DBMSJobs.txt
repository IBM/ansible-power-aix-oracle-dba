...
# =========================
# Description: This module is used to Create & schedule DBMS jobs. It uses a python library located here: ansible_oracle_aix/library/oracle_job
...
# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/job-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
[ansible@x134vm232 ansible_oracle_aix]$ ansible-playbook job-task.yml
