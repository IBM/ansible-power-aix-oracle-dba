...
# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/gi-facts-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
