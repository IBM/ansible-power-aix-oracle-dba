...
# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/roles/oradb-delete/tasks/main.yml and modify the variables. Modify only the ones which are marked with comments.
