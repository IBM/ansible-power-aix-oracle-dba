...
# ==================================
# Description: This module is used run arbitrary SQL Scripts. Single & multiple sql scripts can be run. It uses a python library located here: ansible_oracle_aix/library/oracle_sql.

# Prerequisites:
# ==============
# Passwordless ssh needs to be setup between the Target lpar oracle owner and ansible controller user.

# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/arbitrarysql-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
[ansible@x134vm232 ansible_oracle_aix]$ ansible-playbook arbitrarysql-task.yml
