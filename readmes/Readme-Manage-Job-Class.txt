...
# Playbook: ansible-power-aix-oracle-dba/job-class-task.yml

# Prerequisites:
# ==============
# Set the Variables for Oracle to execute this task: Open the file ansible-power-aix-oracle-dba/job-class-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
# Playbook name: ansible-power-aix-oracle-dba/job-class-task.yml
