...
# Description: # This module is used to manage DBMS job schedules. It uses a python library located here: ansible_oracle_aix/library/oracle_jobschedule.
# Reference: https://docs.oracle.com/database/121/ADMIN/scheduse.htm#ADMIN12674
# Playbook: ansible_oracle_aix/job-schedule-task.yml

# Prerequisites:
# ==============
# Set the Variables for Oracle to execute this task: Open the file ansible_oracle_aix/job-schedule-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
# Playbook name: ansible_oracle_aix/job-schedule-task.yml
