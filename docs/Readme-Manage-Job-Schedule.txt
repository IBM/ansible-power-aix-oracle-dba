...
# Description: # This module is used to manage DBMS job schedules. It uses a python library located here: power-aix-oracle-dba/library/oracle_jobschedule.
# Reference: https://docs.oracle.com/database/121/ADMIN/scheduse.htm#ADMIN12674
# Playbook: power-aix-oracle-dba/job-schedule-task.yml

# Prerequisites:
# ==============
# Set the Variables for Oracle to execute this task: Open the file power-aix-oracle-dba/job-schedule-task.yml and modify the variables under "vars" section. Do NOT change other sections of the file.
...
# Playbook name: power-aix-oracle-dba/job-schedule-task.yml
