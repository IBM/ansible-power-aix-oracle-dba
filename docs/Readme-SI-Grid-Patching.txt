...
# Set the Variables to execute the task: Open the file power-aix-oracle-dba/roles/oraswgi_manage_patches/defaults/main.yml and modify the variables. Modify only the ones which are marked with comments.
