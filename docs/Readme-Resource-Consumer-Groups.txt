...
# Set the Variables for Oracle to execute this task: Open the file ansible-power-aix-oracle-dba/roles/oradb_manage_rsrc/defaults/main.yml and modify the variables
